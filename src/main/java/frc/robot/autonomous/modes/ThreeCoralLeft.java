...
public class ThreeCoralLeft extends SequentialCommandGroup {
    public ThreeCoralLeft(Swerve swerve, Superstructure superstructure) {
        ...
        addCommands(
            ...
            new InstantCommand(() -> {superstructure.requestFeed();}),
            ...
            new InstantCommand(() -> {superstructure.requestLevel(Level.L2);}),
            new AutoPreScore(swerve, superstructure, false),
            new WaitCommand(2),
            new InstantCommand(() -> {superstructure.requestLevel(Level.L3);}),
            new InstantCommand(() -> {superstructure.requestScore();}),
            new InstantCommand(() -> {superstructure.requestIdle();})
        );
    }
