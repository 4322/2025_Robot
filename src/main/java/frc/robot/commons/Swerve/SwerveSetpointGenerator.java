...
package frc.robot.commons.Swerve;

import static frc.robot.commons.EqualsUtil.*;
...
import frc.robot.commons.EqualsUtil;
...
public class SwerveSetpointGenerator {
  ...
  public SwerveSetpoint generateSetpoint(
    ...
    if (desiredState.toTwist2d(dt).epsilonEquals(new Twist2d())) {
      need_to_steer = false;
    ...
    if (all_modules_should_flip
        && !prevSetpoint.chassisSpeeds().toTwist2d(dt).epsilonEquals(new Twist2d())
        && !desiredState.toTwist2d(dt).epsilonEquals(new Twist2d())) {
