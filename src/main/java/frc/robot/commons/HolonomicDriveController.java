...
public class HolonomicDriveController {
   ...
   * @return The next output of the holonomic drive controller.
   */
  public ChassisSpeeds calculate(Pose2d currentPose, PathPlannerTrajectoryState desiredState) {
    return calculate(
        currentPose, desiredState.pose, desiredState.linearVelocity, desiredState.heading);
  }
